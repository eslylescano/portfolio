                        ...
                        {!! Form::open(['action'=>['StudiesController@store'],'method'=>'POST'])!!}
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    ...
                                    {{Form::text('from_date','',['class'=>"form-control", 'placeholder'=>"Place the date when the study started"])}}                                      
                            </div>     
                             </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="input-group">
                                    ...
                                    {{Form::text('to_date','',['class'=>"form-control", 'placeholder'=>"Place the date when the study finished"])}}                                      
                            </div>     
                             </div>
